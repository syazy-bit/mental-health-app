  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 py-2 sm:py-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-slate-600 dark:text-[#AAB6B1] text-xs sm:text-sm sm:leading-relaxed max-w-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <Card variant="default" padding="lg" className="space-y-3">
          ...
          <h2 className="text-sm font-bold text-[#19232D] dark:text-[#F1F3EF]">Transient &amp; Account-Free</h2>
        ...
        <Card variant="default" padding="lg" className="space-y-3">
          <div className="w-9 h-9 rounded-xl bg-[#F4F7F5] dark:bg-[#172320] border border-[#CBD5E1] dark:border-[#283632] flex items-center justify-center text-[#4A6B62] dark:text-[#86A69D]">
            <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
          </div>
          <h2 className="text-sm font-bold text-[#19232D] dark:text-[#F1F3EF]">Anonymous-Optional Booking</h2>
          <p className="text-xs text-slate-600 dark:text-[#AAB6B1] leading-relaxed">
        ...
        <Card variant="default" padding="lg" className="space-y-3">
          <div className="w-9 h-9 rounded-xl bg-[#FFFBEB] dark:bg-[#281F13] border border-[#FDE68A] dark:border-[#5E421E] flex items-center justify-center text-[#D97706] dark:text-[#E7A044]">
            <svg className="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
          </div>
          <h2 className="text-sm font-bold text-[#19232D] dark:text-[#F1F3EF]">Deterministic Safety Engine</h2>
          <p className="text-xs text-slate-600 dark:text-[#AAB6B1] leading-relaxed">
      ...
      <Card variant="sage" padding="lg" className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm text-slate-700">
          <div className="bg-white dark:bg-[#18211F] p-4 rounded-xl border border-[#E6E4DD] dark:border-[#283632] space-y-2 shadow-2xs">
            <span className="font-bold text-[#0D5C56] dark:text-[#4FA79D] uppercase tracking-wider text-xs block">
              What We Provide:
            </span>
            <ul className="list-disc list-inside space-y-1 text-slate-600 dark:text-[#AAB6B1] text-xs leading-relaxed">
          ...
          <div className="bg-white dark:bg-[#18211F] p-4 rounded-xl border border-[#E6E4DD] dark:border-[#283632] space-y-2 shadow-2xs">
            <span className="font-bold text-[#D97706] dark:text-[#E7A044] uppercase tracking-wider text-xs block">
      ...
      <section aria-labelledby="faq-heading" className="space-y-4">
        <h2 id="faq-heading" className="text-base sm:text-lg font-bold text-[#19232D] dark:text-[#F1F3EF]">
          Frequently Asked Questions
        </h2>
        <div className="space-y-3">
          <Card variant="default" padding="md" className="space-y-1">
            <h3 className="text-xs sm:text-sm font-bold text-[#19232D] dark:text-[#F1F3EF]">
      ...
      <div className="pt-4 flex flex-wrap items-center justify-between gap-4 border-t border-[#E6E4DD] dark:border-[#283632]">
        <Link href="/chat">
